...
public class MenuHandler : MonoBehaviour
{
    ...
    public void LoadLiverData()
    {
        ...
        //KJPWorldManager.Instance.voxelMeshConfigurationSettings.voxelSegmentLayers = new string[] { "rkT2.nii" };
        //KJPWorldManager.Instance.voxelMeshConfigurationSettings.voxelDataHotFileName = "rkT1-hot-voxels.csv";
        LoadAFile(true);
    }
